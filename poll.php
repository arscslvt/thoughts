...
<body>
    ...
    <div class="container">
        ...
        <div class="scrollable">
            <?php
                $query = "SELECT * FROM poll, user WHERE poll.codUser = user.idUser  AND poll.idPoll = '$poll'";

                $result = mysqli_query($conn, $query) or die ("Non sono riuscito a scaricare gli ultimi post: " . mysqli_error($conn));
                ...
                if(mysqli_num_rows($result) > 0){
                    ...
                    echo "<p class='error'>🧐 Questo link non porta da nessuna parte. Di al tuo amico di rimandarlo.</p>";
                }
            ?>
        </div>
